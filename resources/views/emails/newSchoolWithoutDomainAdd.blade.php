...
<div id='lower-side'>
    <p>We are pleased to inform you that a new school has registered with the domain {{ $domain }}. However, we noticed that the domain {{ $domain }} is not active in our system.</p>
